...
- Keep WPs sized for one implementer session: 3-7 subtasks, ideally 200-500 lines.
- Split any WP that exceeds 10 subtasks or roughly 700 lines.
- Prefer explicit dependencies, parallel-safe markers, and concrete validation gates.
- Keep guidance actionable; avoid long motivational repetition once the workflow is established.
